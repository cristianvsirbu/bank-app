      ...
      <section
        ...
        <div className="flex 
          ...
          <p className={`${styles.paragraph} 
                        ...
                        text-center
                        sm:text-start`}>
            Experience banking made simple. With our user-friendly interface, competitive rates, and dedicated support, managing your finances has never been easier.</p>
        </div>
