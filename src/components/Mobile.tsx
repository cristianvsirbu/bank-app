    ...
    <section id="mobile" className={`${layout.section}`}>
      <div className={`${layout.sectionImg} flex-col sm:flex-row sm:justify-evenly`}>
        <CardAnimation interval={500} animationClassName="stats">
          <img
            src={screenshot1}
            alt="screenshot1"
            className="w-[270px] h-[590px] md:max-lg:w-[200px] md:max-lg:h-[432px] screenshots mb-10 sm:mb-0"
          />
          <img
            src={screenshot2}
            alt="screenshot2"
      ...
      <div className={`flex-1 flex-col flex items-center md:items-start md:ml-5`}>
        <CardAnimation interval={500} animationClassName="animate">
          <h2 className={`${styles.heading2} text-center md:text-start mt-5 md:mt-0`}>
        ...
        <div className="flex mt-5 w-full justify-center md:justify-start flex-col sm:flex-row">
          <CardAnimation interval={500} animationClassName="stats">
            <img
              src={apple}
              alt="apple"
              className="sm:mr-10 mr-0 mb-10 sm:mb-0 sm:h-[4rem] stores "
            />
