                ...
                <div className='flex flex-col sm:flex-row w-full justify-between items-center'>
                    <CardAnimation interval={500} animationClassName='animate'>
                        {Object.entries(filteredCurrencies).map(([currency, rate]) => (
                            <div key={currency} className='w-[100%] h-[6.5rem] sm:w-[30%] sm:h-[5rem] md:h-[7rem] lg:h-[10rem] py-6 px-5 mt-[40px] box-shadow-50 flex flex-row justify-start items-center bg-[#10151a] cursor-pointer'>
                                <img key={currency} src={rate.image} alt={currency} className='w-[45px] h-[45px] sm:max-md:w-[30px] sm:max-md:h-[30px] lg:w-[60px] lg:h-[60px] ml-[0.5rem] sm:ml-0 lg:ml-[1.5rem] mr-[20px] sm:max-md:mr-[10px]' />
